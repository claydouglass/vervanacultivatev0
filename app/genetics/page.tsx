...
export default function GeneticsPage() {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <Select onValueChange={setSelectedGenetic} value={selectedGenetic}>
        <SelectTrigger className="w-[200px] mb-4">
          <SelectValue placeholder="Select Genetic" />
        </SelectTrigger>
        <SelectContent>
          {mockGenetics.map(genetic => (
            <SelectItem key={genetic.id} value={genetic.id}>{genetic.name}</SelectItem>
          ))}
        </SelectContent>
      </Select>
        ...
        <Tabs defaultValue="performance" className="w-full">
          ...
          <TabsContent value="performance">
            <Card>
              ...
              <CardContent>
                <p className="mb-2">Yield per Square Foot: {currentGenetic.yield.gramsPerSquareFoot} g/ft²</p>
                <p className="mb-2">Yield per Light: {currentGenetic.yield.gramsPerLight} g/light</p>
                <p className="mb-2">Labor Hours: {currentGenetic.laborHours} hours</p>
                <p className="mb-2">Production Cost Range: ${currentGenetic.productionCost.low.toFixed(2)} - ${currentGenetic.productionCost.high.toFixed(2)} per gram</p>
                <p className="mb-2">Average Production Cost: ${currentGenetic.productionCost.average.toFixed(2)} per gram</p>
              </CardContent>
            </Card>
          </TabsContent>
          <TabsContent value="analysis">
            <Card>
              ...
              <CardContent>
                ...
                <p className="mb-2">Yield Efficiency: {(currentGenetic.yield.gramsPerSquareFoot / currentGenetic.laborHours).toFixed(2)} g/ft²/hour</p>
                <p className="mb-2">Cost Efficiency Range:</p>
                <ul className="list-disc pl-5 mb-2">
                  <li>Low: ${(currentGenetic.productionCost.low / currentGenetic.yield.gramsPerLight).toFixed(2)} per gram per light</li>
                  <li>Average: ${(currentGenetic.productionCost.average / currentGenetic.yield.gramsPerLight).toFixed(2)} per gram per light</li>
                  <li>High: ${(currentGenetic.productionCost.high / currentGenetic.yield.gramsPerLight).toFixed(2)} per gram per light</li>
                </ul>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>Optimize lighting cycles to potentially increase yield per light</li>
