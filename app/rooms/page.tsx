...
const rooms = [
  ...
  },
  {
    ...
    vpd: 1.1,
    flowerImage: "/placeholder.svg?height=300&width=300",
    flowerAnalysis: "Kandy Terpz plants are in vigorous vegetative growth, showing strong stem development and lush foliage. Internodal spacing is optimal, indicating a good balance of light intensity and plant stretching.",
    aiSuggestions: [
  ...
  },
  {
    ...
    vpd: 1.2,
    flowerImage: "/placeholder.svg?height=300&width=300",
    flowerAnalysis: "Sweet Dreamz is experiencing healthy vegetative growth, with robust leaf development and strong root systems. The plants show no signs of nutrient deficiencies or pest issues.",
    aiSuggestions: [
